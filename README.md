...
Базовый шаблон (`default.pug`) не предназначен для редактирования. Не стоит в нем задавать значения переменных, подключать
...
то лучше создать другой базовый шаблон (например `custom-default.pug`) унаследованный от `default.pug` (а то и вовсе
